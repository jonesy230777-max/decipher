        ...
        {step === "intro" && (
          <Card>
            ...
            <p className="hig-body" style={{ color: "var(--colour-label)", marginTop: "var(--space-3)" }}>
                        ...
                        <br /><br />
Your results will generate a personalised Sales DNA profile, showing your strengths across four key trait areas and where your biggest development opportunity lies.<br /><br />This audit comes in four versions, built for different sales motions. Choose the one that matches your role below.<br /><br /><strong>Media Sales:</strong> for sales professionals managing existing client relationships, pitching campaigns, renewing accounts, and growing revenue with warm, ongoing contacts.<br /><br /><strong>The Hunter:</strong> for sales professionals who generate their own pipeline. They cold call to book meetings, then present and close the sale online or face to face.<br /><br /><strong>Charity & NFP Fundraising:</strong> for phone fundraisers calling potential donors on behalf of a charity, covering the donor call from opener through to the ask and objection handling.<br /><br /><strong>Retail Media Sales:</strong> for reps selling retail media (onsite, in-store, sponsored placements) to brands, media agencies, and trade/shopper marketing teams, navigating category managers, rate cards, and trading terms.                        <br /><br />
                        Ready? Let's begin.
            </p>
