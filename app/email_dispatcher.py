...
def send_report_email(audit_id: int, report_id: int, pdf_path: str) -> None:
    ...
    text_body = (
    f"Hi {first},\n\n"
    f"Your attached Decipher DNA report is a first read on how you operate under "
    f"pressure. Headline archetype: {archetype}.\n\n"
    f"Treat page 1 as a starting point, not a verdict. Reps who improve fastest "
    f"aren't the most talented ones. They're the ones who figure out their own "
    f"pattern early and work on it on purpose.\n\n"
    f"Reply if you want to talk it through.\n\n"
    f"Steve\n\n"
    f"--\n"
    f"Steve Jones\n"
    f"Trainer & Founder\n"
    ...
    f"<p>Hi {first},</p>"
    f"<p>Your attached <strong>Decipher DNA report</strong> is a first read on how you operate under pressure. Headline archetype: <strong>{archetype}</strong>.</p>"
    "<p>Treat page 1 as a starting point, not a verdict. Reps who improve fastest aren't the most talented ones. They're the ones who figure out their own pattern early and work on it on purpose.</p>"
