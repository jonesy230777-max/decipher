...
CONTENT: dict[tuple[str, str], dict[str, str]] = {
    ...
    ("storytelling", "performing"): {
        ...
        "what_above": "The Elite storyteller designs for the retell. They know a story's job isn't to land in the room, it's to survive the room and get repeated in the boardroom afterwards by someone who wasn't even there. So they build one portable line into every story: a specific image, a number made vivid, a direct quote. “We reached 450,000 people” becomes “we filled a stadium nine times over in a single breakfast shift.” You already make the client the hero. What you don't yet do is engineer the one line that travels. Your best moments arrive by luck. Theirs arrive by design.",
        ...
        "conversation_example": "Performing rep: “We reached 450,000 people.” Elite rep: “We filled a major stadium nine times over in a single breakfast shift. The CMO called it the most talked-about campaign in their category that year.” Same data. Completely different impact.",
    ...
    ("storytelling", "elite"): {
        ...
        "conversation_example": "A teammate says “we reached 450,000 people” and the room nods politely. You reframe it live: “that's filling a stadium nine times over in a single breakfast shift,” and the same room starts repeating the line to each other.",
