"""Seed the Media Sales DNA Audit v1 questions from the canonical brief.

Source of truth: reference_docs/media_sales_v1_full.json
...
Idempotent. Replaces fix_media_sales_v1_questions.py for fresh installs.
"""
...
def main() -> None:
    ...
    with conn() as c, c.cursor() as cur:
        ...
        print(f"Seeded media_sales_v1 (audit_version_id={version_id}) with {len(QUESTIONS)} questions.")
